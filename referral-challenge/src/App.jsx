  ...
  return (
    <div style={{ marginBottom: 28 }}>
      ...
      <div>
        ...
        <div style={{ fontSize: 12, color: C.textSoft, marginTop: 2 }}>{t(lang, "appSub")}</div>
      </div>
    </div>
  );
}
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
            <div style={{
              ...
              <img src="/atomy-logo.png" alt="Atomy Europe" style={{ height: 28 }} />
            </div>
            <span style={{ fontWeight: 900, fontSize: 15, letterSpacing: "-0.3px", color: C.blue }}>
              {t(lang, "appName")}
            </span>
          </div>
