-- ============================================================
--  Atomy EU New Member Registration Challenge
--  Supabase SQL 전체 초기화 v5
...
CREATE TABLE members (
  ...
  mastership  TEXT        DEFAULT '' CHECK (mastership IN ('', 'SM', 'DM', 'SRM', 'STM', 'RM', 'CM', 'IM')),
...
CREATE TABLE referrals (
  ...
  type           TEXT        NOT NULL DEFAULT 'consumer'
                             CHECK (type IN ('distribution', 'consumer')),
