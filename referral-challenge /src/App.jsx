            ...
            :currentRanking.map((m,i)=>(
              <div key={m.id} style={{display:"flex",alignItems:"center",padding:"11px 14px",borderRadius:11,marginBottom:6,background:i===0?C.blueLight:C.white,border:`1px solid ${i===0?C.blueMid:C.border}`}}>
                ...
                <div style={{flex:1}}>
                  ...
                  {m.mastership&&<span style={{background:C.blueLight,color:C.blue,border:`1px solid ${C.blueMid}`,borderRadius:10,padding:"1px 7px",fontSize:11,fontWeight:700,marginLeft:6}}>{m.mastership}</span>}
                  <span style={{fontSize:12,color:C.textSoft,marginLeft:6}}>#{m.member_no}</span>
                </div>
